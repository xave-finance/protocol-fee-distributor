...
import { AvalancheProtocolFeesDistributor } from '../typechain/AvalancheProtocolFeesDistributor'
import { ERC20Token } from '../typechain/ERC20Token'

chai.use(solidity)

let protocolFeesDistributor: AvalancheProtocolFeesDistributor
let token: ERC20Token

const BALANCER_FEE_COLLECTOR = '0xce88686553686DA562CE7Cea497CE749DA109f9F'
const XAVE_FEES_COLLECTOR = '0xD6D88a8C4970CAd9D734872cc3fE94a5A05BeDC8'
...
describe('Avalanche Protocol Fees Distributor', () => {
  before(async () => {
    const ProtocolFeesDistributorFactory = await ethers.getContractFactory('AvalancheProtocolFeesDistributor')
    protocolFeesDistributor = (await ProtocolFeesDistributorFactory.deploy()) as AvalancheProtocolFeesDistributor
